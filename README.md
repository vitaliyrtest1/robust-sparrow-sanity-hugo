...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/601aadc3e1c70900157e7252
...
To start editing your site, you can use the Sanity interface at https://robust-sparrow-sanity-hugo-aadc3.sanity.studio/.
...
Generated at `2021-02-03T14:06:16.815Z` by Stackbit version `0.3.45`.